    ...
    <div class="max-w-[1440px] mx-auto">
        ...
        <div class="lg:hidden px-5 sm:px-8 lg:px-12">
            ...
            <div class="flex flex-col sm:flex-row gap-4 sm:gap-5">
                <div class="img-block sm:w-[45%]" style="aspect-ratio: 438/346; background: linear-gradient(135deg, #f5f5f5 0%, #e8e8e8 50%, #d8d4cf 100%);"></div>
                <div class="img-block sm:w-[55%]" style="aspect-ratio: 900/600; background: linear-gradient(135deg, #ffe5d3 0%, #fcc89b 50%, #f5a262 100%);">
                    <div class="absolute inset-0 flex items-end p-6">
                        <span class="text-white/90 text-[12px] font-mono tracking-[0.18em] uppercase">Equipo · Santo Domingo, RD</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="hidden lg:grid grid-cols-[26%_1fr_48%] items-end gap-6 xl:gap-8 px-5 sm:px-8 lg:px-12">
            <div class="self-end img-block" style="aspect-ratio: 438/346; background: linear-gradient(135deg, #f5f5f5 0%, #e8e8e8 50%, #d8d4cf 100%);">
                <div class="absolute inset-0 flex items-end p-5">
                    <span class="text-[var(--ink-muted)] text-[11px] font-mono tracking-[0.18em] uppercase">Estudio</span>
                </div>
            </div>
            ...
            <div class="self-end img-block" style="aspect-ratio: 3/2; background: linear-gradient(135deg, #ffe5d3 0%, #fcc89b 50%, #f5a262 100%);">
                <div class="absolute inset-0 flex items-end justify-between p-6">
                    <span class="text-white/95 text-[13px] font-mono tracking-[0.18em] uppercase">Equipo · Santo Domingo, RD</span>
                    <span class="text-white/95 text-[13px] font-mono tracking-tight">+80 clientes activos</span>
                </div>
            </div>
        </div>
    </div>
                ...
                <a href="<?= e($href) ?>" class="case-card group block">
                    <div class="case-card__media" style="aspect-ratio: <?= $ratio ?>; background: <?= $bg ?>;">
                        ...
                        <div class="absolute top-5 left-5 right-5 flex items-center justify-between">
                            <span class="text-[11px] font-mono tracking-[0.18em] uppercase" style="color: <?= $textColor ?>;">Caso 0<?= $i + 1 ?></span>
                            <?php if (!empty($proj['year'])): ?>
                                <span class="text-[11px] font-mono" style="color: <?= $textColorMuted ?>;"><?= e($proj['year']) ?></span>
                            <?php endif; ?>
                        </div>
                    ...
                    <h3 class="case-card__title"><?= e($proj['title']) ?></h3>
                </a>
            <?php endforeach; ?>
        </div>
